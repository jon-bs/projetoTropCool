...
import com.tropcool.model.repository.IAccountMailRepository;
import com.tropcool.model.repository.UsuarioRepository;
import com.tropcool.security.RequestContext;
...
public class UsuarioService {
	...
	/*
	 * public Usuario cadastrarUsuario(Usuario usuario) { return
	 * this.usuarioRepository.save(usuario); }
	 * 
	 * public Usuario detalharUsuario(Long id) { Usuario usuario =
	 * this.usuarioRepository.findById(id).orElse(null);
	 * Assert.notNull(usuario,"Usuario de id "+ id + "não encontrado."); return
	 * usuario; }
	 * 
	 * public List<Usuario> listarUsuarios(){ return
	 * this.usuarioRepository.findAll(); }
	 * 
	 * public Usuario atualizarUsuario(Usuario usuario) { return
	 * this.usuarioRepository.save(usuario); }
	 * 
	 * public void removerUsuario(Long id) { this.usuarioRepository.deleteById(id);
	 * }
	 */
	/*-------------------------------------------------------------------
	 *				 		     SERVICES
